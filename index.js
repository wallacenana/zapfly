...
app.post('/marketing/upload', authenticate, uploadMarketing.single('file'), (req, res) => {
    ...
    const fileUrl = `${String(process.env.FILES_URL || 'https://files.digizap.com.br').replace(/\/$/, '')}/marketing/${req.file.filename}`;
...
app.post('/marketing-assets', authenticate, uploadMarketing.single('file'), async (req, res) => {
    try {
        ...
        const finalUrl = url || (req.file ? `${String(process.env.FILES_URL || 'https://files.digizap.com.br').replace(/\/$/, '')}/marketing/${req.file.filename}` : null);
...
app.post('/upload/product', uploadProduct.single('image'), (req, res) => {
    try {
        ...
        const imageUrl = `${String(process.env.FILES_URL || 'https://files.digizap.com.br').replace(/\/$/, '')}/products/${req.file.filename}`;
