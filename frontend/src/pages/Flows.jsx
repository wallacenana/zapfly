...
import { Plus, GitMerge, MoreVertical, Play, Edit2, Copy, Trash2, Smartphone } from 'lucide-react';
  ...
  return (
    <div style={{ padding: '30px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
        ...
        <button className="btn btn-primary" style={{ backgroundColor: '#10b981', gap: '10px' }} onClick={() => navigate('/flows/new')}>
              ...
              <tr key={flow.id} style={{ borderBottom: '1px solid var(--border-color)', transition: 'background 0.2s' }}>
                ...
                <td style={{ padding: '16px 20px', textAlign: 'right' }}>
                  <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '10px' }}>
                    <button className="btn-icon" title="Pausar" style={{ color: '#f59e0b' }}><Play size={16} /></button>
                    ...
                    <button className="btn-icon" title="Duplicar" style={{ color: 'var(--text-secondary)' }}><Copy size={16} /></button>
                    <button className="btn-icon" title="Excluir" style={{ color: 'var(--danger)' }}><Trash2 size={16} /></button>
                  </div>
                </td>
              </tr>
            ))}
