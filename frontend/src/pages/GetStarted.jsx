...
const steps = [
  ...
  { key: 'dailyMaxOrders', title: 'Capacidade da operação', question: 'Quantos pedidos você aceita por dia?', help: 'Defina o limite que sua equipe consegue preparar. Você pode alterar esse número quando quiser.', placeholder: 'Ex.: 25', type: 'number', icon: Store, required: true },
