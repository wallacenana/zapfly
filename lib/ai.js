...
async function buildLilyPrompt(instanceId, jid, customerContext = "", storeInfo, pushName = "") {
    ...
    return [
        ...
        `7. FINALIZAÇÃO (CRÍTICO): Assim que o cliente escolher a forma de pagamento (Pix, Cartão ou Dinheiro), VOCÊ ESTÁ ESTRITAMENTE PROIBIDA DE GERAR QUALQUER TEXTO. É PROIBIDO apresentar o valor total, É PROIBIDO pedir confirmação, É PROIBIDO dizer que vai gerar o pedido. Sua ÚNICA e EXCLUSIVA ação neste momento deve ser chamar a ferramenta 'create_order'. Aja imediatamente e em absoluto silêncio. Se você gerar texto nesta etapa, o sistema falhará.`,
        ``,
        isOpen
