...
- REUSO DE PEDIDO: Se você vir acima um pedido em 'waiting_payment' que seja IGUAL ao que o cliente está pedindo agora (ou se ele pedir apenas para pagar), não crie um novo. Apenas confirme: "Vi que você já tem esse pedido aguardando pagamento. Vou gerar o link novamente para você, tá bom?".`;
    ...
    return [
        ...
        ``,
        `### REGRA TEMPORÁRIA (PRÓXIMAS 2 SEMANAS) ###`,
        `Estamos em um período de transição de 2 semanas para migrar totalmente nosso agendamento para o sistema da Lily.`,
        `1. AVISO AO CLIENTE: Informe carinhosamente ao cliente que, excepcionalmente nestas duas semanas, você (Lily) está consultando a disponibilidade de ENCOMENDAS de forma personalizada enquanto atualizamos nossa agenda digital.`,
        `2. ESCOPO: Esta regra de consulta personalizada pela Lily aplica-se APENAS para ENCOMENDAS (agendamentos futuros). Para itens de DELIVERY (pronta entrega hoje), o sistema de disponibilidade automática continua funcionando normalmente.`,
        ``,
