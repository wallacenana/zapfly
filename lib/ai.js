            ...
            for (const call of msg.tool_calls) {
                ...
                if (call.function.name === "create_order") {
                    ...
                    if (args.assetId) {
                        ...
                        await sock.sendMessage('status@broadcast', { image: { url: asset.path }, caption }, { broadcast: true });
                    } else {
                        if (!caption) throw new Error('Informe o texto do status.');
                        await sock.sendMessage('status@broadcast', { text: caption }, { broadcast: true });
                    }
