...
async function getRestaurantGreeting(instanceId, userId) {
    ...
    return `Ola, eu sou ${assistantName}, ${article} agente virtual d${article} ${restaurantName}. Estou aqui para tirar suas duvidas ou fazer seu pedido. Se quiser agilizar, acesse nosso cardapio digital: ${menuUrl}`;
}
