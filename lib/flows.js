...
const { getStoreStatus, hasAvailableProductStock, getDeliveryCatalog, getRestaurantGreeting, shouldSendRestaurantGreeting } = require('./utils');
        ...
        switch (node.type) {
            ...
            case 'aiNode': {
                ...
                if (storeInfo.statusLoja === 'FECHADA' && asksForDeliveryCatalog && !asksForOrderCatalog) {
                    ...
                    await sock.sendMessage(jid, { text: 'A loja esta fechada no momento. A pronta-entrega funciona dentro do horario de atendimento.' });
                ...
                const toolChoice = asksForDeliveryCatalog
                    ...
                    for (const toolCall of responseMessage.tool_calls) {
                        ...
                        if (functionName === "get_delivery_catalog") {
                            ...
                            try {
                                ...
                                const catalogText = catalogStr.trim() || "Poxa, não encontrei itens no momento.";
