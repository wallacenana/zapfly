    ...
    try {
        ...
        switch (node.type) {
            ...
            case 'aiNode': {
                ...
                const tools = [
                    {
                        ...
                        function: {
                            name: "create_order",
                            description: "Cria um novo agendamento no sistema. Colete cada variacao em uma pergunta separada: uma pergunta, uma resposta, depois a proxima. Nunca junte tamanho e massa, massa e recheio ou duas variacoes na mesma mensagem.",
                            parameters: {
                                type: "object",
                                properties: {
                                    product: { type: "string" },
                ...
                const selectedProduct = requestsCatalog ? null : await findSelectedProduct(userId, currentText, deliveryOrderFollowUp);
