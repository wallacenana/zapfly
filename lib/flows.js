                        ...
                        function: {
                            ...
                            parameters: {
                                ...
                                properties: {
                                    ...
                                    massa: { type: "string", description: "Opcional. Sabor da massa do bolo." },
                                    recheio: { type: "string", description: "Opcional. Sabor do recheio do bolo." },
                                    topo: { type: "string", description: "Opcional. Informações sobre o topo do bolo." },
                                    notes: { type: "string" }
                                },
