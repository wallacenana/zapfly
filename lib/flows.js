...
const { getStoreStatus, hasAvailableProductStock, formatProduct, getDeliveryCatalog, getOrderCatalog, getRestaurantGreeting, shouldSendRestaurantGreeting } = require('./utils');
        ...
        switch (node.type) {
            ...
            case 'aiNode': {
                ...
                const explicitDeliveryCatalogRequest = !explicitOrderCatalogRequest
                    && /delivery|pronta entrega|o que tem|o que temos|temos hoje|tem hoje|tem pra hoje|para hoje|dispon[ií]vel|card[aá]pio|cat[aá]logo|op[cç][õo]es|opcoes|pre[cç]o/.test(normalizedRequest);
                ...
                const toolChoice = explicitOrderCatalogRequest
