    ...
    try {
        ...
        switch (node.type) {
            ...
            case 'aiNode': {
                ...
                const asksForDeliveryCatalog = !asksForOrderCatalog && /delivery|pronta entrega|o que tem|tem hoje|tem pra hoje|dispon[ií]vel|card[aá]pio|cat[aá]logo|opções|opcoes|opção|opcao|pre[cç]o/.test(normalizedRequest);
                    ...
                    for (const toolCall of responseMessage.tool_calls) {
                        ...
                        if (functionName === "get_delivery_catalog") {
                            ...
                            if (!statusLoja.includes('FECHADA')) {
                                introMsg = 'Hoje teremos os seguintes produtos de pronta entrega:';
