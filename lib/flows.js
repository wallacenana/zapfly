...
const { isDeliveryOrderFollowUp, isCatalogRequest, findSelectedProduct } = require('./utils');
    ...
    try {
        ...
        switch (node.type) {
            ...
            case 'aiNode': {
                ...
                const toolChoice = (explicitOrderCatalogRequest || (deliveryOrderFollowUp && requestsCatalog))
