                ...
                const tools = [
                    {
                        ...
                        function: {
                            name: "create_order",
                            description: "Cria um novo agendamento e gera o link de pagamento. Para atendimento ao cliente, use SOMENTE apos item, variacao, adicionais/opcoes cadastrados, data, hora disponivel e nome coletados, resumo apresentado e confirmacao explicita do cliente. Uma escolha de produto ou opcao nao e confirmacao final. Nao invente etapas de massa ou recheio. Colete uma etapa por mensagem. Importacoes administrativas seguem as instrucoes do administrador.",
                            parameters: {
                                type: "object",
                                properties: {
                                    product: { type: "string" },
