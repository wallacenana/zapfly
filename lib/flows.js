...
const { getStoreStatus, hasAvailableProductStock } = require('./utils');
        ...
        switch (node.type) {
            ...
            case 'aiNode': {
                ...
                if (storeInfo.statusLoja === 'FECHADA' && asksForDeliveryCatalog && !asksForOrderCatalog) {
                    ...
                    await sock.sendMessage(jid, { text: 'A loja estÃ¡ fechada no momento. A pronta-entrega funciona dentro do horÃ¡rio de atendimento.' });
                    return true;
                }
