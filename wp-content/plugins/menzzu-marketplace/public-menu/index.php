...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo esc_url(MENZZU_MARKETPLACE_URL . 'public-menu/style.css?v=4.07'); ?>">
        <style>
            :root {
                --primary-color:
    ...
    <body class="<?php echo $isDarkTheme ? 'theme-dark' : 'theme-light'; ?>">
        ...
        <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11" defer></script>
                <script type="text/javascript" src="<?php echo esc_url(MENZZU_MARKETPLACE_URL . 'public-menu/script.js?v=2.33'); ?>" defer></script>
